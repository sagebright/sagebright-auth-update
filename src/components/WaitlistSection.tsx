...
const WaitlistSection = () => {
  ...
  return (
    <section className="section-spacing bg-sagebright-green/10" id="waitlist">
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="p-10 md:p-16">
              <div className="text-center mb-12 text-block">
                <h2 className="text-headline font-dmSans font-bold mb-6">Join Our Beta Waitlist</h2>
                <p className="text-body font-sans text-gray-600 py-4">
