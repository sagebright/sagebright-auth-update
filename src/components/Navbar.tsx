      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a 
              href="#why" 
              className={`text-body font-helvetica text-charcoal hover:text-sagebright-green transition-colors duration-200 group ${isActive('#why') ? 'font-medium text-sagebright-green' : ''}`}
            >
              Why{" "} <span className="text-sagebright-green">sagebright</span>
              <span className={`block h-0.5 bg-sagebright-green transform scale-x-0 group-hover:scale-x-100 transition-transform ${isActive('#why') ? 'scale-x-100' : ''}`}></span>
            </a>
            <a 
              href="#how" 
            ...
            <a 
              href="#who" 
              className={`text-body font-helvetica text-charcoal hover:text-sagebright-green transition-colors duration-200 group ${isActive('#who') ? 'font-medium text-sagebright-green' : ''}`}
            >
              Who We Help
              <span className={`block h-0.5 bg-sagebright-green transform scale-x-0 group-hover:scale-x-100 transition-transform ${isActive('#who') ? 'scale-x-100' : ''}`}></span>
            </a>
          </nav>
