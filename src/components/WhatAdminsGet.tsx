  ...
  return (
    <section className="py-20 bg-sagebright-green/5" id="admins">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:gap-12 mb-12">
          {/* Screenshot Column - 5 columns on desktop, on the left */}
          <div className="w-full lg:w-5/12 lg:pr-6 flex items-center mb-8 lg:mb-0">
          ...
          {/* Cards Column - 7 columns on desktop, on the right */}
